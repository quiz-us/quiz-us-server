...
ActiveRecord::Schema.define(version: 20_190_816_204_706) do
  ...
  create_table 'decks_questions', id: false, force: :cascade do |t|
    ...
    t.index %w[deck_id question_id], name: 'index_decks_questions_on_deck_id_and_question_id', using: :btree
    t.index %w[question_id deck_id], name: 'index_decks_questions_on_question_id_and_deck_id', using: :btree
  end

  create_table 'enrollments', id: false, force: :cascade do |t|
    t.integer 'period_id',  null: false
    t.integer 'student_id', null: false
    t.index %w[period_id student_id], name: 'index_enrollments_on_period_id_and_student_id', using: :btree
    t.index %w[student_id period_id], name: 'index_enrollments_on_student_id_and_period_id', using: :btree
  end
  ...
  create_table 'questions_standards', id: false, force: :cascade do |t|
    ...
    t.index %w[question_id standard_id], name: 'index_questions_standards_on_question_id_and_standard_id', using: :btree
    t.index %w[standard_id question_id], name: 'index_questions_standards_on_standard_id_and_question_id', using: :btree
  end
  ...
  create_table 'standards', force: :cascade do |t|
    ...
    t.string   'meta'
    t.index %w[standards_category_id title], name: 'index_standards_on_standards_category_id_and_title', unique: true, using: :btree
  ...
  create_table 'standards_categories', force: :cascade do |t|
    ...
    t.datetime 'created_at',         null: false
    t.datetime 'updated_at',         null: false
    t.index %w[standards_chart_id title], name: 'index_standards_categories_on_standards_chart_id_and_title', unique: true, using: :btree
